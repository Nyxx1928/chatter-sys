...
- [x] 1. **Install Slack DESIGN.md and create platform token files**
...
- [x] 2. **Map Slack tokens to Tailwind config (web frontend)**
...
- [x] 3. **Add Noto Sans fonts to mobile app**
...
- [x] 4. **Checkpoint — Token Foundation Verified**
...
- [x] 10. **Checkpoint — Auth Flow Complete**
...
- [x] 12. **Redesign chats list screen**
...
- [x] 13. **Redesign chat room detail screen**
...
- [x] 14. **Redesign channels list and detail screens**
...
- [x] 17. **Redesign shared components**
...
- [x] 19. **Verify and polish dark mode on all screens**
