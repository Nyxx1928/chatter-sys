...
- [ ] 7. Checkpoint - Verify WebSocket configuration
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 9. Checkpoint - Verify chat room management
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 11. Checkpoint - Verify message handling
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 21. Implement Zustand stores with TypeScript
  - [ ] 21.1 Create auth store
...
- [ ] 22. Checkpoint - State management complete
  - Ensure all tests pass, ask the user if questions arise.

### Frontend API Integration

- [ ] 23. Implement HTTP API client
  - [ ] 23.1 Create base API client with error handling
  ...
  - [ ] 23.2 Create auth API functions
...
- [ ] 25. Implement STOMP client with TypeScript
  ...
  - [ ] 25.2 Create React hooks for STOMP
  ...
  - [ ] 25.3 Integrate STOMP client with connection store
...
- [ ] 26. Checkpoint - STOMP integration complete
  - Ensure all tests pass, ask the user if questions arise.

### Frontend UI Components

- [ ] 27. Create reusable UI components with mobile-first design
  - [ ] 27.1 Create base UI components
  ...
  - [ ] 27.2 Create authentication form components
  ...
  - [ ] 27.3 Create chat UI components
...
- [ ] 29. Create Next.js pages with App Router
  - [ ] 29.1 Create root layout and home page
  ...
  - [ ] 29.2 Create authentication pages
...
- [ ] 31. Integrate STOMP subscriptions in chat pages
  - [ ] 31.1 Connect to STOMP on authentication
