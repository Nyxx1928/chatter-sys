...
export function FooterSection({ className = '' }: FooterSectionProps) {
  return (
    <footer
      className={`border-t border-white/5 bg-[#0a0a0f] px-6 py-12 ${className}`.trim()}
      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex-shrink-0">
            ...
            <p className="mt-3 text-sm text-white/40">© 2025 Chatter Inc.</p>
          </div>
          ...
          <div className="flex items-center gap-4 lg:flex-shrink-0">
            ...
            <a
              href="#"
              aria-label="Facebook"
              className="text-white/40 transition-colors hover:text-white focus:outline-none focus-visible:text-white"
            >
