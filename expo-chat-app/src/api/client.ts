...
const getErrorMessage = (details: unknown): string => {
  ...
  if (details && typeof details === 'object') {
    const detailObject = details as { message?: unknown; errors?: Record<string, unknown> };
    if (typeof detailObject.message === 'string' && detailObject.message.trim()) return detailObject.message;
